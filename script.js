...
function displayFeaturedFoods() {
    ...
    featuredItems.forEach(food => {
        ...
        foodCard.innerHTML = `
            ...
            <div class="food-info">
                <h3>${food.name}</h3>
                <p>RS${food.description}</p>
                <span class="price">RS ${food.price.toFixed(2)}</span>
...
function updateCartUI() {
    ...
    cart.forEach(item => {
        ...
        cartItem.innerHTML = `
            <div class="item-info">
                <h4>${item.name}</h4>
                <p class="item-price">RS${item.price.toFixed(2)} each</p>
            </div>
...
`;
  ...
  Price: RS ${item.price.toFixed(2)} x ${item.quantity} =  ${itemTotal}
-------------------------------------
`;
    });
